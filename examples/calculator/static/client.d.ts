...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc1faa76763f5b90a: (a: number, b: number) => void;
